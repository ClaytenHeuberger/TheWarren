...
public class GameManager : MonoBehaviour
{
    ...
    const string MODULE_NAME = "thewarren";
    ...
    */
    ...
    public static Dictionary<uint, PlayerServerController> Players = new Dictionary<uint, PlayerServerController>();
    ...
    void HandleConnect(DbConnection conn, Identity identity, string token)
    {
        ...
        conn.Db.Ship.OnInsert += ShipOnInsert;
    ...
    private void HandleSubscriptionApplied(SubscriptionEventContext ctx)
    {
        ...
        ctx.Reducers.EnterGame("Electrix");
    }
    ...
    private static void ShipOnInsert(EventContext context, Ship insertedValue)
    {
        var player = GetOrCreatePlayer(insertedValue.PlayerId);
        var entityController = PrefabManager.SpawnShip(insertedValue, player);
    ...
    private static PlayerServerController GetOrCreatePlayer(uint playerId)
    {
        ...
        Debug.Log("Player created/retrieved: " + playerId);
